...
- Taxonomy support for categories, tags, and custom taxonomies
- Eliminated file system dependency and permission issues
- Automatic Content-Type: application/xml headers
